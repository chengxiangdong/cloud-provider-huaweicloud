...
func init() {
	...
	//flag.DurationVar(&pollTimeout, "timeout", 300*time.Second, "poll-timeout defines the time which the poll operation times out")
	flag.DurationVar(&pollTimeout, "ginkgo.timeout", 300*time.Second,
